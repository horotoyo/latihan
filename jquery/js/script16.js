$(document).ready(function(){
	...
	$("#tambahinput2").click(function(){
		$("#kotak1").prepend("<br><input type='text' name='nama' placeholder='Nama Lengkap'>");
	});
	$("#tambahinput3").click(function(){
		$("#kotak1").after("<br><input type='text' name='nama' placeholder='Nama Lengkap'>");
	});
	$("#tambahinput4").click(function(){
		$("#kotak1").before("<br><input type='text' name='nama' placeholder='Nama Lengkap'>");
	});

	$("#tambah1").click(function(){
		var string1 = "<br><strong>Kalimat 1</strong>";
		var string2 = "<em> Kalimat</em>";
